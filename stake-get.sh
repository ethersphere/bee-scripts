...
# This script retrieves stake information from multiple Bee nodes in a specified Kubernetes namespace.
# It requires 'kubectl' and 'curl' to be installed on the system.
# Usage: ./stake-get.sh [NAMESPACE] [DOMAIN]
# Example: ./stake-get.sh bee-testnet testnet.internal
